...
By default, the Grafana OSS image (`grafana/grafana`) is used for all Docker-related commands. You can override this behavior by setting the `GRAFANA_IMAGE` environment variable.
